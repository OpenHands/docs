...
echo "📁 Generated Python SDK docs: sdk/api-reference/"
echo "📁 Generated Agent Server OpenAPI spec: openapi/agent-server.json"
...
echo "2. Verify the OpenAPI spec in openapi/agent-server.json"
echo "3. Copy the configuration from scripts/mint-config-snippet.json"
echo "4. Add it to your docs.json navigation structure"