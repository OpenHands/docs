...
<Columns cols={3}>
  ...
  >
    Explore the complete Python SDK API and source code.
  </Card>
  <Card
    title="REST API Reference"
    href="/sdk/guides/agent-server/api-reference/server-details/alive"
  >
    HTTP/WebSocket API for remote agent server deployments.
  </Card>
</Columns>
