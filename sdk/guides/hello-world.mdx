...
The default agent includes BashTool, FileEditorTool, etc. See the [tools package source code](https://github.com/OpenHands/agent-sdk/tree/main/openhands-sdk/openhands/tools) for the complete list of available tools.
