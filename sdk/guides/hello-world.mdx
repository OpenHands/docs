...
The default agent includes BashTool, FileEditorTool, etc. See the [tools package source code](https://github.com/All-Hands-AI/agent-sdk/tree/main/openhands-sdk/openhands/tools) for the complete list of available tools.
