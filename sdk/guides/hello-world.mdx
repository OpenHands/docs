...
```python icon="python" examples/01_standalone_sdk/01_hello_world.py wrap expandable
import os
...
Note that the model name prefixes depend on your provider
...
You can set the model via `LLM_MODEL` env var.
