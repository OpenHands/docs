...
The default agent includes BashTool, FileEditorTool, etc. See the [tools package source code](https://github.com/OpenHands/software-agent-sdk/tree/main/openhands-sdk/openhands/sdk/tool) for the complete list of available tools.
