...
You may define your own router by extending the `Router` class. See the [base class](https://github.com/All-Hands-AI/agent-sdk/blob/main/openhands-sdk/openhands/sdk/llm/router/base.py) for details.
