...
<Note>
This example is available on GitHub: [examples/01_standalone_sdk/19_llm_routing.py](https://github.com/OpenHands/agent-sdk/blob/main/examples/01_standalone_sdk/19_llm_routing.py)
</Note>
...
You may define your own router by extending the `Router` class. See the [base class](https://github.com/OpenHands/agent-sdk/blob/main/openhands-sdk/openhands/sdk/llm/router/base.py) for details.
