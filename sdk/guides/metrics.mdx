...
- **[Prompt Token Composition](/sdk/guides/llm-prompt-composition)** - Offline report that breaks down prompt tokens per call into system prompt, tool schemas, history, and latest message
