...
```python icon="python" wrap focus={7, 11}
...
5. **Understand failure behavior**: If one tool fails, others in the same batch may continue. Check logs for partial results
