---
title: Route Task to Model
description: Route each task to the best LLM profile with the built-in route_task_to_model tool.
---
...
```python icon="python" wrap focus={4-6}
...
```python icon="python" wrap focus={2-9}
...
```python icon="python" wrap focus={2-12}
