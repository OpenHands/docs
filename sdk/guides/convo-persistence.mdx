...
This structure provides granular access to conversation history, making it easy to inspect individual events, debug agent behavior, or process conversation data programmatically.
