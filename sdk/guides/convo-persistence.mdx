...
<Note>
This example is available on GitHub: [examples/01_standalone_sdk/10_persistence.py](https://github.com/OpenHands/agent-sdk/blob/main/examples/01_standalone_sdk/10_persistence.py)
</Note>
...
For the complete implementation details, see the [ConversationState class](https://github.com/OpenHands/agent-sdk/blob/main/openhands-sdk/openhands/sdk/conversation/state.py) in the source code.
