...
<Note>
This example is available on GitHub: [examples/01_standalone_sdk/22_anthropic_thinking.py](https://github.com/OpenHands/agent-sdk/blob/main/examples/01_standalone_sdk/22_anthropic_thinking.py)
</Note>
...
<Note>
This example is available on GitHub: [examples/01_standalone_sdk/23_responses_reasoning.py](https://github.com/OpenHands/agent-sdk/blob/main/examples/01_standalone_sdk/23_responses_reasoning.py)
</Note>
