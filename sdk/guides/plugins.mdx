...
The example below demonstrates plugin loading via Conversation and plugin management utilities (install, list, load, and uninstall).
...
<Note>
Source: [examples/05_skills_and_plugins/03_plugin_enable_disable/main.py](https://github.com/OpenHands/software-agent-sdk/blob/main/examples/05_skills_and_plugins/03_plugin_enable_disable/main.py)
</Note>

```python icon="python" expandable examples/05_skills_and_plugins/03_plugin_enable_disable/main.py
