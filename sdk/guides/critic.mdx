...
The Critic feature enables real-time evaluation of agent actions and messages using an LLM. It provides quality scores and feedback during agent execution to help assess agent performance.
