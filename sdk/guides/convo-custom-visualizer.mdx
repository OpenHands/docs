...
This shows how you can pass a ConversationVisualizer instance directly to the visualize parameter for clean, reusable visualization logic.
"""
...
def main():
    ...
    print("🚀 Starting conversation with custom visualizer...")
    print("=" * 60)
    ...
    print(f"📊 Total steps executed: {custom_visualizer.step_count}")
