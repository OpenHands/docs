...
<Note>
This example is available on GitHub: [examples/01_standalone_sdk/24_planning_agent_workflow.py](https://github.com/OpenHands/agent-sdk/blob/main/examples/01_standalone_sdk/24_planning_agent_workflow.py)
</Note>
...
For a complete implementation example showing all these components working together, refer to the [planning agent preset source code](https://github.com/OpenHands/agent-sdk/blob/main/openhands-tools/openhands/tools/preset/planning.py).
