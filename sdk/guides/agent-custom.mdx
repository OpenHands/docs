...
For a complete implementation example showing all these components working together, refer to the [planning agent preset source code](https://github.com/All-Hands-AI/agent-sdk/blob/main/openhands-tools/openhands/tools/preset/planning.py).
