...
<Note>
This example is available on GitHub: [examples/03_github_workflows/01_basic_action/assign-reviews.yml](https://github.com/OpenHands/agent-sdk/blob/main/examples/03_github_workflows/01_basic_action/assign-reviews.yml)
</Note>

Automatically manage pull request review workflows using OpenHands Agent to organize open PRs, assign reviewers, and notify authors when action is needed.

## How Basic Action Works

The basic action workflow (`01_basic_action`) provides a flexible template for running arbitrary maintenance tasks in GitHub Actions:
...
- Identifies PRs waiting for review (clean state, CI passing, no activity for 3+ days)
...
# Add: LLM_API_KEY (get from https://docs.all-hands.dev/openhands/usage/llms/openhands-llms)
...
- [Agent Script](https://github.com/OpenHands/agent-sdk/blob/main/examples/03_github_workflows/01_basic_action/agent_script.py)
- [Workflow File](https://github.com/OpenHands/agent-sdk/blob/main/examples/03_github_workflows/01_basic_action/assign-reviews.yml)
- [Basic Action README](https://github.com/OpenHands/agent-sdk/blob/main/examples/03_github_workflows/01_basic_action/README.md)
