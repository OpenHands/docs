...
See [Tools Overview](/sdk/arch/tools/overview) for the complete list of available tools.
...
These components are tied together by a **ToolDefinition** that registers the tool with the agent. For architectural details and advanced usage patterns, see [Tool System Architecture](/sdk/arch/sdk/tool).
