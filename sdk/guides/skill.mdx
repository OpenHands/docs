...
<Note>
Source: [examples/05_skills_and_plugins/04_skill_enable_disable/main.py](https://github.com/OpenHands/software-agent-sdk/blob/main/examples/05_skills_and_plugins/04_skill_enable_disable/main.py)
</Note>

```python icon="python" expandable examples/05_skills_and_plugins/04_skill_enable_disable/main.py
...
<Note>
Source: [examples/05_skills_and_plugins/05_skill_uninstall/main.py](https://github.com/OpenHands/software-agent-sdk/blob/main/examples/05_skills_and_plugins/05_skill_uninstall/main.py)
</Note>

```python icon="python" expandable examples/05_skills_and_plugins/05_skill_uninstall/main.py
