...
`~/.openhands/skills/installed/` with a `.installed.json` metadata file and can
be enabled or disabled; `load_installed_skills` returns enabled skills only.
...
# Enable/disable controls which skills load
