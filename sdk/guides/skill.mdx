...
- **With `triggers`**: Skill is listed in `<SKILLS>` section; content injected when keyword detected
- **Without `triggers`**: Skill is always active; full content included in system prompt
