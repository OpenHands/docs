...
<CardGroup cols={3}>
  <Card title="AGENTS.md" icon="file-lines">
    **Best for: Repository-wide rules**
  ...
  <Card title="Always-Active Skills" icon="circle-check">
    **Best for: Custom SDK behavior**
    
    - Define in code or `.openhands/skills/`
    - Always in system prompt
    - Full programmatic control
  </Card>
  <Card title="Keyword-Triggered Skills" icon="bolt">
    **Best for: On-demand knowledge**
...
## AGENTS.md (Recommended for Repos)

For repository-wide instructions, create an `AGENTS.md` file at your repo root:
...
OpenHands automatically loads this file. You can also create model-specific variants:
- `CLAUDE.md` - Instructions specific to Claude models
- `GEMINI.md` - Instructions specific to Gemini models

<Tip>
`AGENTS.md` is the recommended approach for repository-level instructions because it's automatically loaded and works with other AI coding tools.
</Tip>

## Keyword-Triggered Skills

For specialized knowledge that should only appear when relevant, use keyword triggers:
...
When the user says "encrypt this file", the skill content is injected:
...
## Always-Active Skills (Code-Based)

For programmatic control, define always-active skills in code:
