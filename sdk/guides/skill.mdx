...
### Marketplace-Filtered Loading

If you want to load a curated subset of public skills, provide a marketplace JSON path instead of loading the full repository.

This example is available on GitHub: [examples/01_standalone_sdk/43_mixed_marketplace_skills/main.py](https://github.com/OpenHands/software-agent-sdk/blob/main/examples/01_standalone_sdk/43_mixed_marketplace_skills/main.py)
