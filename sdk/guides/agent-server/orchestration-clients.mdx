...
Call `register_default_tools()` before attaching so standard tool event schemas,
including browser events, can be decoded. Register any additional custom tools
used by the remote agent as well.
