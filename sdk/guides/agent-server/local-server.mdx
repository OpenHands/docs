...
The `working_dir` value is a path relative to the server's working directory. The default layout places conversation files under `workspace/bash_events/`, `workspace/conversations/`, and agent task files under `workspace/project/`.
