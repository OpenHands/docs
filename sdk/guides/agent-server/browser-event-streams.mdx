...
<Note>
This guide accompanies [software-agent-sdk #5012](https://github.com/OpenHands/software-agent-sdk/issues/5012).
...
your application owns rendering and workflow decisions.
...
The transport requires a Web-standard global `WebSocket` when started and has no
