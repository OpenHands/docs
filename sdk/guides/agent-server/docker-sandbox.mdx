...
with DockerWorkspace(
    ...
    server_image="ghcr.io/all-hands-ai/agent-server:main-python",
    host_port=8010,
...
Read the API Reference [here](/sdk/guides/agent-server/api-reference/vscode/get-vscode-url) for more information.
...
Read the API Reference [here](/sdk/guides/agent-server/api-reference/desktop/get-desktop-url) for more information.
