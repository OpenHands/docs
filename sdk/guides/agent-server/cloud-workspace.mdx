...
The `OpenHandsCloudWorkspace` connects to OpenHands Cloud to provision sandboxes, allowing you to run agents with your own LLM configuration in a managed cloud environment.
...
The `OpenHandsCloudWorkspace` can be used in GitHub Actions for CI/CD workflows. See the [PR Review Workflow](/sdk/guides/github-workflows/pr-review) for a complete example that demonstrates running code reviews in cloud mode:
