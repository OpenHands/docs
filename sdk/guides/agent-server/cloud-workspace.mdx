...
## Inherit SaaS Credentials from OpenHands Cloud

If your OpenHands Cloud account already has an LLM configured, you can let the sandbox inherit that configuration
and your registered secrets. This removes the need to set `LLM_API_KEY` locally and keeps raw secret values inside
OpenHands Cloud and the sandbox runtime.
...
```bash Running the Example
export OPENHANDS_CLOUD_API_KEY="your-cloud-api-key"
# Optional: override the cloud app URL or model
# export OPENHANDS_CLOUD_API_URL="https://app.all-hands.dev"
