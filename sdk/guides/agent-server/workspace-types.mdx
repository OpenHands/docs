...
| Workspace | Best For | Infrastructure | Isolation | SaaS<br/>Creds |
|-----------|----------|----------------|:---------:|:--------------:|
| Local / Path | Development, testing | None | ❌ | ❌ |
| Docker | Local isolation, CI/CD | Local Docker | ✅ | ❌ |
| Apptainer | HPC, shared compute | Singularity | ✅ | ❌ |
| API | Self-managed infra | Runtime API | ✅ | ❌ |
| Cloud | Production, managed | OpenHands Cloud | ✅ | ✅ |
