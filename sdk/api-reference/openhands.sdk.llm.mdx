...
- `subscriber`: Callable[[[RegistryEvent](#openhands.sdk.llm.RegistryEvent)], None] | None
- ``: property usage_to_llm : dict[str, [LLM](#openhands.sdk.llm.LLM)]
...
- `message`: [Message](#openhands.sdk.llm.Message)
...
- `content`: Sequence[[TextContent](#openhands.sdk.llm.TextContent) | [ImageContent](#openhands.sdk.llm.ImageContent)]
...
- `responses_reasoning_item`: [ReasoningItemModel](#openhands.sdk.llm.ReasoningItemModel) | None
- `role`: Literal['user', 'system', 'assistant', 'tool']
- `thinking_blocks`: Sequence[[ThinkingBlock](#openhands.sdk.llm.ThinkingBlock) | [RedactedThinkingBlock](#openhands.sdk.llm.RedactedThinkingBlock)]
- `tool_call_id`: str | None
- `tool_calls`: list[[MessageToolCall](#openhands.sdk.llm.MessageToolCall)] | None
- `vision_enabled`: bool
...
- `active_llm`: [LLM](#openhands.sdk.llm.LLM) | None
- `llms_for_routing`: dict[str, [LLM](#openhands.sdk.llm.LLM)]
- `model_config`: ClassVar[ConfigDict] = (configuration object)
  Configuration for the model, should be a dictionary conforming to [ConfigDict][pydantic.config.ConfigDict].
- `router_name`: str
