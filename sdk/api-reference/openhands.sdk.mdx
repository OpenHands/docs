...
Bases: [`AgentBase`](openhands.sdk.agent.mdx#class-agentbase)
...
Bases: [`Event`](openhands.sdk.event.mdx#class-event), `ABC`
...
Bases: [`BaseWorkspace`](openhands.sdk.workspace.mdx#class-baseworkspace)
...
* Returns:
  ...
  : timeout_occurred
* Return type:
  [CommandResult](openhands.sdk.workspace.mdx#class-commandresult)
...
* Return type:
  [FileOperationResult](openhands.sdk.workspace.mdx#class-fileoperationresult)
...
Bases: [`Observation`](openhands.sdk.tool.mdx#class-observation)
...
Bases: [`LLMConvertibleEvent`](openhands.sdk.event.mdx#class-llmconvertibleevent)
...
Bases: `RemoteWorkspaceMixin`, [`BaseWorkspace`](openhands.sdk.workspace.mdx#class-baseworkspace)
