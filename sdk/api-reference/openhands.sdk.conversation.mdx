...
- ``: abstract property conversation_stats : [ConversationStats](openhands.sdk.md#openhands.sdk.ConversationStats)
...
- `stats`: [ConversationStats](openhands.sdk.md#openhands.sdk.ConversationStats)
...
- `agent`: [AgentBase](openhands.sdk.agent.mdx#class-agentbase)
- ``: property conversation_stats : [ConversationStats](openhands.sdk.md#openhands.sdk.ConversationStats)
