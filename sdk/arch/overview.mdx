...
<Note>
For API details and implementation, see the [OpenAPI docs](/api-reference/agent-sdk/overview) and [source code](https://github.com/OpenHands/agent-sdk/tree/main/openhands-agent-server).
</Note>
