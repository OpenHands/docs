...
**Source**: [`openhands/agent_server/`](https://github.com/OpenHands/agent-sdk/tree/main/openhands/agent_server)
...
**Full API Reference**: See [OpenAPI Specification](/api-reference/agent-sdk/introduction)
...
- [Local Agent Server](/sdk/guides/agent-server/local-agent-server) - Run locally
- [Docker Sandboxed Server](/sdk/guides/agent-server/docker-sandboxed-server) - Docker setup
- [API Sandboxed Server](/sdk/guides/agent-server/api-sandboxed-server) - Remote API
- [Remote Agent Server Overview](/sdk/guides/agent-server/overview) - All options

### For Related Architecture

- [Workspace Package](/sdk/arch/workspace-package) - RemoteAPIWorkspace details
- [SDK Package](/sdk/arch/sdk-package) - Core framework
- [Architecture Overview](/sdk/arch/overview) - System design

### For API Reference

- [OpenAPI Specification](/api-reference/agent-sdk/introduction) - Full API docs

### For Implementation Details

- [`openhands/agent_server/`](https://github.com/OpenHands/agent-sdk/tree/main/openhands/agent_server) - Server source
