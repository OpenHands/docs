...
- Source: [`conversation.py`](https://github.com/OpenHands/software-agent-sdk/blob/main/openhands/sdk/conversation.py)
...
- Integrates with skills (formerly known as microagents) for specialized behavior

**Design decisions**:
- **Stateless**: Agent doesn't hold state, operates on Conversation
- **Extensible**: Behavior can be modified via skills (formerly known as microagents)
...
- Source: [`agent.py`](https://github.com/OpenHands/software-agent-sdk/blob/main/openhands/sdk/agent.py)
...
- Source: [`llm.py`](https://github.com/OpenHands/software-agent-sdk/blob/main/openhands/sdk/llm.py)
...
- Source: [`tool/`](https://github.com/OpenHands/software-agent-sdk/tree/main/openhands/sdk/tool)
...
- Source: [`workspace.py`](https://github.com/OpenHands/software-agent-sdk/blob/main/openhands/sdk/workspace.py)
...
- Source: [`event.py`](https://github.com/OpenHands/software-agent-sdk/blob/main/openhands/sdk/event.py)
...
- Source: [`condenser/`](https://github.com/OpenHands/software-agent-sdk/tree/main/openhands/sdk/condenser)
...
- Source: [`mcp/`](https://github.com/OpenHands/software-agent-sdk/tree/main/openhands/sdk/mcp)
...
**Design decisions**:
- **Composable**: Multiple skills (formerly known as microagents) can work together
- **Declarative**: Defined as configuration, not code
- **Reusable**: Share skills (formerly known as microagents) across agents

**Why skills (formerly known as microagents)?** Instead of hard-coding behaviors, skills (formerly known as microagents) let you compose agent personalities and capabilities. Like "plugins" for agent behavior.

**Example skills (formerly known as microagents)**:
...
- Source: [`microagents/`](https://github.com/OpenHands/software-agent-sdk/tree/main/openhands/sdk/microagents)
...
- Source: [`security/`](https://github.com/OpenHands/software-agent-sdk/tree/main/openhands/sdk/security)
...
- [`openhands/sdk/`](https://github.com/OpenHands/software-agent-sdk/tree/main/openhands/sdk) - Full source code
