...
>
> ```bash
> export LLM_MODEL="openhands/claude-sonnet-4-5-20250929"  # for OpenHands Cloud
> ```
...
```bash
# Using OpenHands Cloud (two options)
# 1) If the example reads LLM_MODEL (many do):
export LLM_MODEL="openhands/claude-sonnet-4-5-20250929"
uv run python examples/01_standalone_sdk/01_hello_world.py

# 2) If the example hardcodes the model string:
#    Edit the code to replace "anthropic/..." with "openhands/claude-sonnet-4-5-20250929"
