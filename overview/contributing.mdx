...
Issues labeled `ready-for-dev` have been triaged and meet the criteria for development work — see [Issue Triage and the ready-for-dev Gate](/overview/issue-lifecycle) for how issues get labeled and what the pull request description check requires.
