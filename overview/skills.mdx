...
|----------|---------------|---------------------|----------------|---------------|
| **CLI** | ✅ Full Support | `~/.openhands/skills/` (user-level) and `.openhands/skills/` (repo-level) | File-based markdown | [CLI Mode](/openhands/usage/run-openhands/cli-mode#using-skills-with-cli) |
...
<Tabs>
  <Tab title="CLI">
    ...
    - See [CLI Skills Documentation](/openhands/usage/run-openhands/cli-mode#using-skills-with-cli) for details
  </Tab>
  <Tab title="SDK">
