...
| **Agent Canvas** | ✅ Full Support | `.agents/skills/` + UI | File-based with UI management | [Customize and Settings](/openhands/usage/agent-canvas/customize-and-settings) |
...
<Tabs>
  ...
  <Tab title="Agent Canvas">
    - Visual skill management through `Customize`
    - File-based storage with UI editing
    - Real-time skill status display
    - Backend-aware customization workflows
  </Tab>
