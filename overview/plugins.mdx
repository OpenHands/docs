...
<Info>
OpenHands also loads packages published in the portable [Agent Plugins](/overview/agent-plugins) format, which places `plugin.json` at the package root instead of in a metadata directory.
</Info>
