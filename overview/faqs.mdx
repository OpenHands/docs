...
1. **Quick start**: Use [OpenHands Cloud](/enterprise/usage/cloud/openhands-cloud) to get started quickly with
  [GitHub](/enterprise/usage/cloud/github-installation), [GitLab](/enterprise/usage/cloud/gitlab-installation),
  [Bitbucket](/enterprise/usage/cloud/bitbucket-installation),
  and [Slack](/enterprise/usage/cloud/slack-installation) integrations.
