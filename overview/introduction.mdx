...
Use Agent Canvas for the current local and self-hosted OpenHands UI. It runs from your terminal, connects to local or remote backends, and includes views for conversations, customization, settings, and automations.

[Check out the docs](https://docs.openhands.dev/openhands/usage/agent-canvas/setup) or [view the source](https://github.com/OpenHands/agent-canvas).
