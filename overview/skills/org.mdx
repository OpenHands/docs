---
title: Organization and User Skills (formerly Microagents)
description: Organizations and users can define skills (formerly known as microagents) that apply to all repositories belonging to the organization or user.
---

## Usage

These skills (formerly known as microagents) can be [any type of skill](/overview/skills/overview#skill-types) and will be loaded
...
skills (formerly known as microagents) in that directory.
...
For GitLab organizations, the same skill (formerly known as microagent) would be located inside the `openhands-config` repository.
...
When running OpenHands on your own, you can place skills (formerly known as microagents) in the `~/.openhands/microagents` folder on your local
