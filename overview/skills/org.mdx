...
These skills can be [any type of skill](/overview/skills/overview#skill-types) and will be loaded
...
When running OpenHands on your own, you can place skills in the `~/.openhands/microagents` folder on your local
