...
3. **Add content** (see structure below)

4. **Test it** by using a trigger keyword in your prompt

<Tip>
**Let OpenHands help you create skills**: Simply ask OpenHands to "create a skill" or "write a new skill" and the `skill-creator` skill will guide you through an interactive process. It asks questions about your use cases, suggests appropriate structure, and helps you write effective triggers and descriptions. This is especially helpful when you're starting out or want guidance on best practices.
</Tip>
