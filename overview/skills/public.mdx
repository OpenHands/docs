...
description: Global skills (formerly known as microagents) are [keyword-triggered skills](/overview/skills/keyword) that apply to all OpenHands users. The official global skill registry is maintained at [github.com/OpenHands/skills](https://github.com/OpenHands/skills).
---
...
See the [CONTRIBUTING.md](https://github.com/OpenHands/skills/blob/main/CONTRIBUTING.md) for specific instructions on how to contribute a global skill.
