...
You should see run commands at the bottom of each PR for testing your GUI or CLI changes. If you do not, here is the template:

#### Testing GUI changes with Docker
```
# Replace ${SHORT_SHA} with the short commit SHA associated with your PR
...
#### Testing CLI changes with uvx
```
# Replace ${BRANCH_NAME} with the name of your branch in the OpenHands GitHub repo.

uvx --python 3.12 --from git+https://github.com/All-Hands-AI/OpenHands@${BRANCH_NAME}#subdirectory=openhands-cli openhands"
```
...
- Report issues to [contact@openhands.dev](mailto:contact@openhands.dev)
