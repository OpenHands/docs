...
- [Connect to GitHub](/enterprise/usage/settings/integrations-settings#github-setup),
  [connect to GitLab](/enterprise/usage/settings/integrations-settings#gitlab-setup)
  and [connect to Bitbucket](/enterprise/usage/settings/integrations-settings#bitbucket-setup).
