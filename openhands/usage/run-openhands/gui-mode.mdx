...
- [Connect to GitHub](/usage/run-openhands/gui-mode#github-setup), [connect to GitLab](/usage/run-openhands/gui-mode#gitlab-setup)
  and [connect to Bitbucket](/usage/run-openhands/gui-mode#bitbucket-setup).
...
- Be specific in your requests to get the most accurate and helpful responses, as described in the [prompting best practices](/openhands/usage/tips/prompting-best-practices).
...
- [Run OpenHands with a friendly CLI.](/usage/run-openhands/cli-mode)
- [Run OpenHands on GitHub issues with a GitHub action.](/usage/run-openhands/github-action)
