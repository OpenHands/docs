...
For token-by-token streaming output in ACP mode, use the `--streaming` flag:

```bash
toad acp "openhands acp --streaming"
```

This provides real-time feedback as the LLM generates responses.
