...
<Note>
VS Code does not have native ACP support, but a community extension is available. This extension is maintained by [Omer Cohen](https://github.com/omercnet) and is not officially supported by OpenHands.
</Note>
