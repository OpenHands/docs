...
- Windows without WSL (see [Windows Without WSL Guide](/openhands/usage/windows-without-wsl))
...
<Accordion title="Windows">
  ...
  **Alternative: Windows without WSL**
  ...
  If you prefer to run OpenHands on Windows without WSL or Docker, see our [Windows Without WSL Guide](/openhands/usage/windows-without-wsl).
...
For more details, see the [Search Engine Setup](/openhands/usage/search-engine-setup) guide.
