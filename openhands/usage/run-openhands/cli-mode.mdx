...
**Example: Adding Tavily Remote MCP Server**

To add [Tavily's](https://www.tavily.com/) remote MCP server for AI-powered search and data extraction, create or edit `~/.openhands/mcp.json`:
