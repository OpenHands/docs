---
title: Headless (Python/Docker)
description: Run OpenHands programmatically with Python or Docker for advanced scripting and automation.
---

This page covers running OpenHands directly with Python or Docker. For the simpler CLI headless mode, see [CLI Headless Mode](/openhands/usage/run-openhands/cli-mode#headless-mode).

<Note>
**Which should I use?**
- **CLI headless mode** (`openhands --headless`) - Simpler, recommended for most automation tasks
- **Python/Docker headless** - Direct control, custom configurations, advanced integrations
</Note>
