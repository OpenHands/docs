...
The CLI automatically loads skills from:
- `~/.openhands/skills/` - User-level skills that apply to all conversations
- `.openhands/skills/` - Repository-level skills for the current directory

### Skill Types

- **[General Skills](/overview/skills/repo)**: Repository-wide guidelines (e.g., `repo.md`) that are always active
- **[Keyword-Triggered Skills](/overview/skills/keyword)**: Skills activated by specific keywords in user prompts (require frontmatter with `triggers:` field)
