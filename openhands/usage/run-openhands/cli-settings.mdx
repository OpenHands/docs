...
Skills are specialized prompts that provide domain-specific knowledge to OpenHands. They are enabled by default in the CLI and load automatically from:

- `~/.openhands/skills/` - User-level skills for all conversations
- `.openhands/skills/` - Repository-level skills for the current directory

For detailed information about creating and using skills, see [Using Skills with CLI](/openhands/usage/run-openhands/cli-mode#using-skills-with-cli).
