...
via a `.openhands/hooks.json` file and work across **Cloud**, **CLI**, and **local GUI** setups.
...
This is the hook setup behind the linting enforcement that Graham Neubig [highlighted](https://x.com/gaborneubig) � it
prevents the agent from finishing if pre-commit, tests, or CI are failing.
