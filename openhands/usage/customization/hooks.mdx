...
The `.openhands/hooks.json` file maps hook event types to matchers and commands.

Both `snake_case` and `PascalCase` keys are supported:

<Tabs>
  <Tab title="snake_case (recommended)">
```json
{
  "pre_tool_use": [
    {
