...
Skills (formerly known as microagents) allow you to extend OpenHands prompts with information specific to your project and define how OpenHands
should function. See [Skills Overview](/overview/skills/overview) for more information.
