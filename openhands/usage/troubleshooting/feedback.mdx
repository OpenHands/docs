...
The data is collected and stored by [OpenHands](https://openhands.dev), a company founded by OpenHands maintainers to support and improve OpenHands.
...
For data on the OpenHands servers, we are happy to delete it at request:
