...
<Info>
**OpenHands Cloud**: These application settings are only available in OpenHands Cloud. For local installations, use configuration files or environment variables.
</Info>
