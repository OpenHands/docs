...
<Info>
**OpenHands Cloud**: These integration settings are primarily available in OpenHands Cloud. Some integrations may also be configured when running OpenHands locally.
</Info>
