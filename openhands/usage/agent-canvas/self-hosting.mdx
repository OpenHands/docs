...
## 5. (Optional) Connect from Another Machine

You don't have to use the remote UI. On your local machine, start just the frontend:

```bash
agent-canvas --frontend-only
```

Then add the self-hosted deployment as a backend:
