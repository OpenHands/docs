...
- run Agent Canvas on a dedicated host or VM
- open the UI there directly, or through a secure reverse proxy
- or connect a local Agent Canvas instance to that remote backend through `Manage Backends`
