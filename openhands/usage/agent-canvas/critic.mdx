...
likelihood score. Expanding the result shows detected issue categories and
probabilities, such as incomplete changes, missing validation, infrastructure
issues, or likely user follow-up patterns.

![Agent Canvas conversation showing critic success likelihood scores and expanded potential issue categories](/openhands/static/img/agent-canvas-critic-result.png)
