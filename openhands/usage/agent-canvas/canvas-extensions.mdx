...
<Tabs>
  <Tab title="Git Repository">
    ...
    When you paste a browser folder URL, Agent Canvas reads the source, `Ref`, and `Repo path` from the URL. A value you enter in `Ref` or `Repo path` overrides the corresponding part of the URL.
  </Tab>
