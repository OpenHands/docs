...
The LLM Model selector always remains visible in the chat launcher and allows you to select from any available LLM that the current Agent Profile supports. Existing conversations keep the Agent Profile and LLM Profile they were launched with.
