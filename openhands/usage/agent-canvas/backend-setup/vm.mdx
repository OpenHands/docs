...
## 4. Connect from Your Local Agent Canvas

On your laptop, open Agent Canvas and add the VM as a backend:
...
Then use `http://localhost:8000` as the backend URL in Agent Canvas.
