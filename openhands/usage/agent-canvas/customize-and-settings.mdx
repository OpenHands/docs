...
The same page includes a **Color Theme** setting that changes Agent Canvas appearance. Choose a theme from the dropdown; the selection persists across sessions. Two light themes are available:
...
<Note>
  The exact set of available themes can change between releases. Open `Settings > Application` to see the themes your installed version offers.
</Note>
