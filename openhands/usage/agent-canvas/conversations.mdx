...
Select the meter to open the usage drawer, which shows token usage and provider balance details. From the usage drawer, you can manually compact the conversation to reduce context consumption.
