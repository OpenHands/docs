...
Select the meter to open the usage drawer, which shows token usage and provider balance details. You can manually compact the conversation to reduce context consumption by clicking "Compact context".
