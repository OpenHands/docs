...
This page documents the recommended install path for Agent Canvas: install the published package globally with npm, then start it with the `agent-canvas` command.
...
4. Start a conversation from the `Code` view.
