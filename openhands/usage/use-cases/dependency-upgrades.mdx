...
automation:
  card_title: Dependency Upgrades
  ...
  alt_tab_title: Learn More
  alt_tab_body: >-
    See the [full use case guide](/openhands/usage/use-cases/dependency-upgrades)
    for strategies on handling breaking changes, planning major upgrades,
    and validating after updates.
---
