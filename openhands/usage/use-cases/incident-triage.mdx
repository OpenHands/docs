...
automation:
  card_title: Incident Monitoring
  ...
  alt_tab_title: Plugin
  alt_tab_body: >-
    Use the [Datadog debugging workflow](https://github.com/OpenHands/software-agent-sdk/tree/main/examples/03_github_workflows/04_datadog_debugging)
    for deeper error analysis with Datadog integration. See the
    [full use case guide](/openhands/usage/use-cases/incident-triage).
---
