...
automation:
  card_title: Automated Code Review
  ...
  alt_tab_body: >-
    Use the [pr-review plugin](https://github.com/OpenHands/extensions/tree/main/plugins/pr-review)
    for inline review comments on every PR. See the
    [full use case guide](/openhands/usage/use-cases/code-review).
---
