...
|------|-------------|-----------------|----------|
| **SDK Mode** (default) | Runs the agent locally in GitHub Actions | `LLM_API_KEY`, `GITHUB_TOKEN` | Local execution |
| **Cloud Mode** | Runs in an OpenHands Cloud sandbox | `LLM_API_KEY`, `GITHUB_TOKEN`, `OPENHANDS_CLOUD_API_KEY` | Managed infrastructure |
