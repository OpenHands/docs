...
Open `Automate` → `Templates`, search for each template below, and choose `Continue with local setup`. Each template uses the saved token named in its form and allowed by its selected profile.
...
The walkthrough targets [neubig/airbnb-clone](https://github.com/neubig/airbnb-clone). In the recorded deployment, the developer completed [PR #66](https://github.com/neubig/airbnb-clone/pull/66), the reviewer ran the full test suite and posted [a readable exact-head review](https://github.com/neubig/airbnb-clone/pull/66#pullrequestreview-5204337436), and the watchdog merged the accepted head one minute later. The earlier factory completed [neubig/box-clone](https://github.com/neubig/box-clone) with automated development, review, testing, and acceptance.
