...
![Agent Canvas first-time setup — Choose your agent](/openhands/static/img/agent-canvas-setup-step-1.png)
...
![Agent Canvas first-time setup — LLM configuration](/openhands/static/img/agent-canvas-setup-step-3.png)
...
![Agent Canvas first-time setup — connected backend](/openhands/static/img/agent-canvas-setup-step-2.png)
