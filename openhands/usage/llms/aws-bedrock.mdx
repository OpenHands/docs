...
- `Custom Model`: `us.anthropic.claude-3-5-sonnet-20241022-v2:0`
...
This issue was fixed in recent versions of OpenHands (1.5+). Make sure you're using `latest` or a recent release tag.
