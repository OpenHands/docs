...
page focuses on how the OpenHands interfaces surface those capabilities. When in doubt, refer to the <a href="/api-reference/agent-sdk/llm/llm">SDK documentation</a>
...
[`LLM.load_from_env()` schema](/api-reference/agent-sdk/llm/llm#load_from_env) before being passed to the Agent SDK:
