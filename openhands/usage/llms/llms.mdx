...
<Info>
OpenHands now delegates all LLM orchestration to the <a href="/sdk/arch/llms/index">Agent SDK</a>. The guidance on this
page focuses on how the OpenHands interfaces surface those capabilities. When in doubt, refer to the <a href="/sdk/arch/llms/configuration">SDK documentation</a>
