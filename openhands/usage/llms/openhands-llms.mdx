...
<Note>
When you use OpenHands as an LLM provider in the CLI, OpenHands may track minimal model usage to understand how models are used (e.g., agent vs. condenser). This metadata is sent to All Hands AI to help improve the OpenHands experience. We never sell this data.
</Note>
