...
3. Refinement triggers if **either** condition is met:
   ...
   - Any specific issue has a probability above the **issue threshold** (default: 75%), even if the overall score is acceptable (e.g., insufficient testing at 82% triggers refinement even when the overall score is 70%)
