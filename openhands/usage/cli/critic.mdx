...
1. Open Settings with `Ctrl+S`
2. Navigate to the **Critic Settings** tab
3. Toggle on **Iterative Refinement**
4. Optionally adjust the **Refinement Threshold** (1–100%)
...
1. Open Settings with `Ctrl+S`
2. Navigate to the **Critic Settings** tab
3. Toggle off **Enable Critic (Experimental)**
