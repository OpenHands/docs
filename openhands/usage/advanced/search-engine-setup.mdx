...
<Info>
**Local GUI Only**: These search engine configuration options are only available when running OpenHands in Local GUI mode. OpenHands Cloud has Tavily search pre-configured.
</Info>
