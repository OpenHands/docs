...
<Info>
**Local GUI Only**: Custom sandbox configuration is only available when running OpenHands in Local GUI mode. OpenHands Cloud uses managed sandbox environments.
</Info>
