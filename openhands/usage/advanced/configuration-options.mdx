...
<Info>
**Local GUI Only**: These configuration options are only available when running OpenHands in Local GUI mode. For OpenHands Cloud, use the web-based settings interface.
</Info>
