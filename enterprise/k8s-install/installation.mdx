...
- **TLS certificates covering all of the hostnames above** — via cert-manager or
  your own certificates. This is not optional: the application generates
  `https://` URLs throughout, and in-cluster components verify the certificates.
  Wildcard certificates require a DNS-01-capable issuer.
