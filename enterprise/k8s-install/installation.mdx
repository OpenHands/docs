...
- A DNS hostname for the application and a TLS strategy (cert-manager or your own certificates)
...
Create a `values.yaml` with your environment-specific configuration. A minimal
starting point:
