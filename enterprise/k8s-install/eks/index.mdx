...
|---|---|
| EKS version | 1.32–1.35 (the range [Sysbox](/enterprise/k8s-install/eks/sysbox) supports) |
...
- **Sysbox** — the agent sandboxes, one pod per session. These need the Sysbox runtime, which
  ...
  [Installing Sysbox](/enterprise/k8s-install/eks/sysbox).
...
[DNS and TLS](/enterprise/k8s-install/eks/dns-and-tls).

## Next Steps

<CardGroup cols={2}>
  <Card title="Installing Sysbox" icon="cube" href="/enterprise/k8s-install/eks/sysbox">
