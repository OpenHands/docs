...
<Accordion title="Screenshot: Application step">
  <Frame>
    <img
      src="/enterprise/integrations/saml-providers/images/authentik-01-application.png"
      alt="Authentik New application wizard, Application step"
...
<Accordion title="Screenshot: Choose a Provider Type step">
  <Frame>
    <img
      src="/enterprise/integrations/saml-providers/images/authentik-02-provider-type.png"
      alt="Authentik wizard, Choose a Provider Type step with SAML Provider selected"
      style={{maxWidth: '600px'}}
    />
  </Frame>
</Accordion>
...
<Accordion title="Screenshot: Protocol settings">
  <Frame>
    <img
      src="/enterprise/integrations/saml-providers/images/authentik-03-protocol-settings.png"
      alt="Authentik Configure SAML Provider, Protocol settings with ACS URL and Audience"
      style={{maxWidth: '600px'}}
    />
  </Frame>
</Accordion>
...
<Accordion title="Screenshot: Certificates and property mappings">
  <Frame>
    <img
      src="/enterprise/integrations/saml-providers/images/authentik-04-cert-mappings.png"
      alt="Authentik Advanced protocol settings, signing certificate and property mappings"
      style={{maxWidth: '600px'}}
    />
  </Frame>
</Accordion>
...
<Accordion title="Screenshot: Signing toggles">
  <Frame>
    <img
      src="/enterprise/integrations/saml-providers/images/authentik-05-signing-toggles.png"
      alt="Authentik signing toggles with Sign assertions enabled by default"
      style={{maxWidth: '600px'}}
    />
  </Frame>
</Accordion>
...
The remaining provider options include the Service Provider Binding, Default
NameID Policy, and digest and signature algorithms shown below.

<Accordion title="Screenshot: Binding, NameID policy, and algorithms">
  <Frame>
    <img
      src="/enterprise/integrations/saml-providers/images/authentik-06-binding-nameid.png"
      alt="Authentik Service Provider Binding set to Post and Default NameID Policy set to Persistent"
      style={{maxWidth: '600px'}}
    />
  </Frame>
</Accordion>
...
<Accordion title="Screenshot: Configure Bindings step">
  <Frame>
    <img
      src="/enterprise/integrations/saml-providers/images/authentik-07-bindings.png"
      alt="Authentik Configure Bindings step with no bound policies"
      style={{maxWidth: '600px'}}
    />
  </Frame>
</Accordion>
...
<Accordion title="Screenshot: Review and Submit step">
  <Frame>
    <img
      src="/enterprise/integrations/saml-providers/images/authentik-08-review.png"
      alt="Authentik Review and Submit step showing application and provider details"
      style={{maxWidth: '600px'}}
    />
  </Frame>
</Accordion>
