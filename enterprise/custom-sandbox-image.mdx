...
password and stores it in the `admin-password` secret. The helper script in Step 2 reads the secret. If
the value is empty, the script reports an error before a save or delete.
