...
3. [Invite team members](/enterprise/usage/cloud/organizations/managing-members) to join your organization.
4. Configure your organization's [LLM settings](/enterprise/usage/cloud/organizations/settings) and shared resources.

## Next Steps

- [Managing Members](/enterprise/usage/cloud/organizations/managing-members) - Learn how to invite users and manage roles.
- [Organization Settings](/enterprise/usage/cloud/organizations/settings) - Configure LLM providers, credits, and Git organization claims.
- [Roles and Permissions](/enterprise/usage/cloud/organizations/roles-permissions) - Understand the different permission levels.
