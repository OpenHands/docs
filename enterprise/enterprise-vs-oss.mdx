...
OpenHands is available in two deployment options: **Open Source** for individual developers and small teams running the Local GUI on their own machines, and **OpenHands Enterprise** for organizations that need advanced collaboration, integrations, and management capabilities.

## Feature Comparison

The table below highlights the key differences between the Open Source Local GUI and OpenHands Enterprise offerings:

| Feature | Open Source Local GUI | OpenHands Enterprise |
|---------|-------------------|----------------------|
...
The Open Source Local GUI is ideal for:
