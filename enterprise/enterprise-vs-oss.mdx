...
OpenHands is available in two deployment options: **Open Source** for individual developers and small teams building SDK-powered workflows, and **OpenHands Enterprise** for organizations that need advanced collaboration, integrations, and management capabilities.
