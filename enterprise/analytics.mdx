...
Before you begin, make sure you completed `quick-start.mdx`.
...
Ingest only keys are recommended as they only have write access to write traces. They cannot be used to read data.

![Configure Laminar Ingest Only Key](./images/laminar-ingest-only-key.png)

## Set Laminar Project API Key to get conversation traces
...
<video
  ...
  src="https://github.com/user-attachments/assets/e5c5bfee-b73c-400a-9283-b4845340417a"
></video>
