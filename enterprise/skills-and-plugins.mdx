...
|---|---|---|
| Repository context | One repository | Instructions should apply whenever OpenHands works in the repository |
| Repository skill | One repository | A focused workflow or reference should load on demand |
| Organization skills | Organization | Standards should be available across the organization's conversations |
| User skills | One user | A skill should follow one user across conversations |
