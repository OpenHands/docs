...
<Note>
  GitLab Self-Hosted integrations, Bitbucket Data Center integrations, and Jira Data Center integrations are available on OpenHands Enterprise only and is not supported on OpenHands Cloud (SaaS).
</Note>
